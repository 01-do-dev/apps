          ...
          {isAutoSelect
            ? (
              <>
                ...
                />
                <article className='warning'>{t<string>('The auto-selection is done on the current profitability of the validators taking your favorites into account. It is adjusted based on the commission and current range of backing for the Gatekeeper. The calculation may and will change over time, so it is rather a selection based on the current state of the network, not a predictor of future profitability.')}</article>
              </>
            )
            : (
              <InputAddressMulti
